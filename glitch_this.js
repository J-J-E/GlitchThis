...
class ImageGlitcher{
    ...
    glitch_image(img_rgb_data, glitch_amount, color_offset, scan_lines, blurIntensity, frames){
        ...
        this.get_glitched_img(glitch_amount, color_offset, scan_lines, blurIntensity)   ;
    }

    get_glitched_img(glitch_amount, color_offset, scan_lines, blurIntensity){
